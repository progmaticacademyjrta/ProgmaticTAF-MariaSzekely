...
public class LoginPage {
    ...
    By errosMessagetLocaton = By.cssSelector("p[class='lead text-danger']");
    ...
    public void errorMessageVisible() {
        WebElement errormessage = wait.until(ExpectedConditions.visibilityOfElementLocated(errosMessagetLocaton));
